...
#Body variables
#Body variables
$BodyMachineGroupName = "$[Machinegroup Name]"
$BodyMachineGroupFolder = "$[Folder]"
$BodyMachineGroupDescription = "$[Machinegroup Description]"
...
{
  # Create machinegroup with credentials. We have to search for them
